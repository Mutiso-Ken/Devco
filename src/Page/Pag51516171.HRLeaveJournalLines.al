...
begin
                        ...
                        if UserSetup.Find('-') then begin
                            if UserSetup."Post Leave Days Allocations" = false then begin
                                Error('Restricted! You dont have permission to post');
                            end else begin
    ...
    procedure CheckGender(Emp: Record "HR Employee"; LeaveType: Record "HR Leave Types") Allocate: Boolean
    begin
