...
Page 51516897 "MICRO Receipts"
{
    ...
    layout
    {
        area(content)
        {
            group(Transaction)
            {
                ...
                {
                    ApplicationArea = Basic;
                    OptionCaption = 'Member,Debtor,G/L Account,FOSA Loan,Bank Account,Vendor';
    ...
    var
        ...
        RecAlloc: Record "Receipt Allocation";
    ...
    begin
        ...
        if ("Account Type" <> "account type"::Customer) and ("Account Type" <> "account type"::"FOSA Loan") then begin
            LineNo := LineNo + 10000;
        ...
        if ("Account Type" = "account type"::Customer) or ("Account Type" = "account type"::"FOSA Loan") then begin
            ...
            if ReceiptAllocations.Find('-') then begin
                repeat
                    ...
                    GenJournalLine."External Document No." := "Cheque No.";
                    GenJournalLine."Posting Date" := "Transaction Date";
                    if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::"Co-op Shares" then begin
