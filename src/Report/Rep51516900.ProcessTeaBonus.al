...
Report 51516900 "Process Tea Bonus"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Process Tea Bonus.rdlc';
                ...
                if "Salary Processing Buffer".USER = ProcessingUser then begin
                    ...
                    if Account.Get("Salary Processing Buffer"."Account No.") then begin
                        ...
                        or ("Salary Processing Buffer"."Account No." = '350010') then
                            ...
                            GenJournalLine.Description := 'Tea Bonus Payout';
                        ...
                        TeaBonusCharges.Reset;
                        TeaBonusCharges.SetFilter(TeaBonusCharges."Lower Band", '<=%1', RunBal);
                        TeaBonusCharges.SetFilter(TeaBonusCharges."Upper Band", '>=%1', RunBal);
                        if TeaBonusCharges.Find('-') then begin
                            ProcFee := TeaBonusCharges.Charge;
                        ...
                        and ("Salary Processing Buffer"."Account No." <> '350010') then begin
                            ...
                            if SittingAll = true then
                                ...
                                GenJournalLine.Description := 'Tea Bonus Processing Fee';
                            ...
                            GenJournalLine.Description := 'Excise Duty on Tea Bonus';
                        ...
                        if SittingAll = false then begin
                            ...
                            if Account."Account Category" <> Account."account category"::Branch then
                                //RunBal:=("Salary Processing Buffer".Amount-ProcFee)+AvailableBal;
                                //RunBal:=("Salary Processing Buffer".Amount-ProcFee)+AvailableBal;
                                RunBal := "Salary Processing Buffer".Amount - (ProcFee + ExciseFee);

                            //MESSAGE('runbal BEFORE INTEREST IS%1',RunBal);
                            ...
                            Loans.SetRange(Loans."Client Code", "Salary Processing Buffer"."Client Code");  //28th jan
                            Loans.SetRange(Loans."Recovery Mode", Loans."recovery mode"::"Tea Bonus");
                            ...
                            SDATE := '..' + Format(startDate);
                            Loans.Reset;
                            Loans.SetCurrentkey(Loans.Source, "Client Code", Loans."Loan Product Type", Loans."Issued Date");
    ...
    var
        ...
        TeaBonusCharges: Record "Tea Bonus Charges";
    ...
    begin
        ...
        ObjOverdraftRegister.SetRange(ObjOverdraftRegister."Recovery Mode", ObjOverdraftRegister."recovery mode"::Bonus);
