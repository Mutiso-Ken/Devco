...
Table 51516111 "Payroll Posting Groups"
{
    ...
    fields
    {
        ...
        field(34; "Gratuity Employee Acc"; Code[50])
        {
            TableRelation = "G/L Account";
        }
        field(35; "Gratuity Employer Acc"; Code[50])
        {
            TableRelation = "G/L Account";
        }
        field(36; "Housing Employee Acc"; Code[50])
        {
            TableRelation = "G/L Account";
        }
        field(37; "Housing Employer Acc"; Code[50])
        {
            TableRelation = "G/L Account";
        }
        field(38; "Housing Levy Employee Acc"; Code[50])
        {
            TableRelation = "G/L Account";
        }
        field(39; "Housing Levy Employer Acc"; Code[50])
        {
            TableRelation = "G/L Account";
        }
    }
