...
Table 51516183 "Payroll Monthly Transactions"
{
    ...
    fields
    {
        ...
        field(40; "Co-Op parameters"; enum CoopParameters)
        {
        }
        ...
        field(49; "Original Amount"; Decimal)
        {
        }
        field(50; "Bpay Count"; Integer)
        {
            CalcFormula = count("Payroll Monthly Transactions" where("Transaction Code" = filter('BPAY')));
