...
Table 51516437 "Loans Register TEST"
{
            ...
            begin
                ...
                if CustomerRecord.Get("Client Code") then begin
                    ...
                    if CustomerRecord."FOSA Account" = '' then
                        Error('This member does not have a FOSA Savings Account');
                    if CustomerRecord."ID No." = '' then
                        Error('This member does not have an ID Number,kindly rectify that before you proceed');
                    //-------------------------------------------------
