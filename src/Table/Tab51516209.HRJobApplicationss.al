...
Table 51516209 "HR Job Applicationss"
{
    Caption = 'HR Job Applications';

    fields
    {
        field(1;"Application No";Code[100])
        {
        }
            ...
            begin
                ...
                //
                 ...
                 if StrLen("ID Number") > 8 then
                  Error('Member ID No. Can not be Greater than 10 Characters');
                 end;
            end;
        }
        ...
        {
            // TableRelation = "HR Employee Requisitions"."Requisition No." where (Closed=const(No),
        ...
        field(82;"PWD Certificate No";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(83;"Disability Description";Text[250])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    var
        ...
        //AppRefferees: Record UnknownRecord51516212;
       // AppHobbies: Record UnknownRecord51516647;
