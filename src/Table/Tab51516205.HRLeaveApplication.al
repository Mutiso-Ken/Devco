...
Table 51516205 "HR Leave Application"
{
    ...
    fields
    {
        ...
        field(3; "Leave Type"; Code[30])
        {
            ...
            begin
                ...
                if HRLeaveTypes.Find('-') then begin
                    if (format(HRLeaveTypes.Gender) <> format(Gender)) and (format(HRLeaveTypes.Gender) <> format(HRLeaveTypes.Gender::Both)) then begin
        ...
        {
            CalcFormula = lookup("HR Employee"."Leave Allowance Amount" where("No." = field("Employee No")));
        ...
        field(3975; Reliever2; Code[50])
        {
            ...
            begin
                ...
                if HREmp.Get(Reliever2) then
                    "Reliever Name2" := HREmp."Full Name";
            end;
        }
    ...
    begin
        ...
        if HREmp.Find('-') then begin
            ...
            HREmp.CalcFields(HREmp.Picture);
            Picture := HREmp.Picture;
            "Cell Phone Number" := HREmp."Mobile Number";
            "E-mail Address" := HREmp."Email Address";
            Supervisor := HREmp.SupervisorName;
    ...
    var
        ...
        GeneralOptions: Record "HR General Setup";
        LeaveTypes: Record "HR Leave Types";
        ObjHrEmployee: Record "HR Employee";
    ...
    begin
        ...
        if HRSetup.Find('-') then begin
            HRSetup."Leave Template" := 'LEAVE';
            HRSetup."Leave Batch" := 'DEFAULT';
            HRSetup.Modify();
    ...
    begin
        ...
        if HREmailParameters.Find('-') then begin
            ...
            Error('write code to send email');
