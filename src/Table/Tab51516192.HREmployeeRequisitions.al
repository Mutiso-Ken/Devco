...
Table 51516192 "HR Employee Requisitions"
{
    ...
    fields
    {
        ...
        field(8;"Job Description";Text[250])
        {
            Editable = false;
        }
        ...
        {
            OptionMembers = "New Vacancy",Transfer,Replacement,Retirement,Retrenchment,Demise,Other;
        }
    ...
    begin
        ...
        if userSetup.Get(UserId) then begin
          //MESSAGE('"Responsibility Center" %1 "Global Dimension 2 Code" %2',userSetup."Global Dimension 1 Code",userSetup."Global Dimension 2 Code");
          "Responsibility Center":=userSetup.Branch;
          "Global Dimension 2 Code":=userSetup."Department Code";
        end;
