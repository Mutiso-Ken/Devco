...
Table 51516210 "HR Leave Planner Lines"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "HR Leave Planner Header"."Application Code";
        }
        ...
        field(3978; "Application Code"; Code[20])
        {
    ...
    keys
    {
        key(Key1; "Application Code", "Leave Type", "Line No.")
        {
            Clustered = true;
        }
    }
    ...
    var
        ...
        URL: Text[500];
        sDate: Record Date;
        //Customized: Record UnknownRecord51516224;
    ...
    begin
        ...
        HRSetup.Find('-');
        //HRSetup.TESTFIELD(HRSetup."Base Calendar");BaseCalendarChange.SETFILTER(BaseCalendarChange."Base Calendar Code",HRSetup."Base Calendar");
