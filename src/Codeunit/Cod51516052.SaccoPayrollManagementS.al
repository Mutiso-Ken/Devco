codeunit 51516052 "Sacco Payroll ManagementS"
{
    trigger OnRun()
    begin
    end;
    ...
    begin
        ...
        if SelectedPeriod <> dtOpenPeriod then begin
            exit;
        end;
        ...
        if curBasicPay > 0 then begin
            ...
            //....................................End of Calculating Earnings
            //............Gross pay=basic pay+earnings+salary Arrears
            ...
            fnUpdatePeriodTrans(strEmpCode, 'HLEVY', TGroup, TGroupOrder, TSubGroupOrder,
                strTransDescription, curTransAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, PayrollPostingGroup."Housing Levy Employee Acc",
                    ...
                    if prTransactionCodes.Find('-') then begin
                        ...
                        if (prTransactionCodes."Special Transaction" = prTransactionCodes."special transaction"::"Life Insurance")
                          and (prTransactionCodes."Deduct Premium" = false) then begin
                            curTransAmount := 0;//gratuity should now fall here 
                        end;
