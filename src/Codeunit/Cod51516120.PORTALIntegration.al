...
//                 MemberAccountEntry.Add('Account_Number'+Members."No.", Members."No.");
...
//   local  procedure FnRegisterKin(MemberId_Number: Text[30]; "Full Names": Text; Relationship: Text; "ID Number": Code[10]; "Phone Contact": Code[10]; EmailAddress: Text; Percentage: Decimal; Benificiary: Boolean)
//     begin
//         begin
//             objRegMember.Reset;
//             objNextKin.Reset;
