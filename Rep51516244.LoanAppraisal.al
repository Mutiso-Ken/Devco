        ...
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            dataitem("Loans Guarantee Details"; "Loans Guarantee Details")
            {
                ...
                begin
                    ...
                    if CustRecord.Get("Loans Guarantee Details"."Member No") then begin
                        ...
                        AvailableG := CustRecord."Current Shares" * 3;
                    end;
                    //LoanG.CALCFIELDS(LoanG."Free Shares");
                    ...
                    if LoanG.Find('-') then begin
                        //LoanG.CALCFIELDS(LoanG.TotalLoanQuaranteedNew);
                        AvailableG := LoanG."Free Shares";
                        AmountofFreeShares := LoanG."Free Shares" - LoanG."Amont Guaranteed";
                        //MESSAGE('%1',);
                    end;
                    // MESSAGE('avai%1|free%2|guar%3|%4',AvailableG,AmountofFreeShares,LoanG."Amont Guaranteed",LoanG."Loan No");
                    //GuaranteedAmount:=0;
                    LoanG.Reset;
            ...
            begin
                ...
                */
                ...
                //***********************End Charges*********************************//
                // LoanTopUp.RESET;
                // LoanTopUp.SETRANGE(LoanTopUp."Loan No.",LoanAp."Loan  No.");
                // IF LoanTopUp.FIND('-') THEN BEGIN
                // LoanTopUp.RESET;
                // LoanTopUp.SETRANGE(LoanTopUp."Loan Top Up",LoanApp."Loan  No.");
                // IF LoanTopUp.FIND('-') THEN BEGIN
                ...
                if LoanAp.Get("Loans Register"."Loan  No.") then begin
                    ...
                    //   //DeboosterAmount:=ROUND(("Requested Amount"-MaxDepositQualification)/LoanType."Deposits Multiplier",0.01,'>');
                    //   DeboosterAmount:=ROUND(("Requested Amount"-MaxDepositQualification)/"Loans Register"."Total DeductionsH",0.01,'>');
                    //   "Amount Boosted":=DeboosterAmount;

                    //   //MESSAGE('StatDeductions is %1',"Amount Boosted");
                    //   "Commission on Boosting":=ROUND(DeboosterAmount*(LoanType."Comission on Deboosting(%)"/100),0.01,'>');
